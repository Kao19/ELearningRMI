...
public class ClientGUI extends JFrame implements ActionListener {
	...
	ClientGUI() throws MalformedURLException, RemoteException, NotBoundException{
    ...
    public void affectation() throws MalformedURLException, RemoteException, NotBoundException{
        ...
        String[] classesTab = new String[classes.size()];
        for (int i = 0; i < classes.size(); i++) {
            classesTab[i] = classes.get(i);
        }     
        
        final JComboBox cb = new JComboBox(classesTab);    
    ...
    public JPanel chatRoomGui() throws MalformedURLException, NotBoundException, RemoteException{
        ...
        ArrayList<String> student = log.listeClassesEtudiant(textField1.getText(), textField2.getText());
        JTextArea listeStudents = new JTextArea(30, 15);
        
        Set<String> s = new LinkedHashSet<String>(student);  
        List<String> list = new ArrayList<String>(s);
        
        String[] profClass = log.profETclasse(textField1.getText(), textField2.getText());

        listeStudents.append("Prof:" + profClass[0] + " \nClasse: " + profClass[1] + "\n\nListe des etudiants:\n");
        for(int i=0; i<list.size();i++){
            listeStudents.append(list.get(i)+"\n");
            System.out.println(list.get(i));
        }
        
		JScrollPane jScrollPane1 = new JScrollPane(listeStudents);
        ...
        p.add( jScrollPane1, BorderLayout.EAST);
